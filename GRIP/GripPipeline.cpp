...
void GripPipeline::Process(cv::Mat& source0){
	...
	double hslThresholdHue[] = {33.99280575539569, 145.90443686006827};
	double hslThresholdSaturation[] = {0.0, 126.49338769165286};
	double hslThresholdLuminance[] = {0.0, 126.62969283276449};
